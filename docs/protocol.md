        # Hta Transportability: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/hta-transportability.git

        ## Objective

        HTA Transportability Engine quantifies the degree to which evidence from clinical trials can be transported to target HTA populations using reweighting and sensitivity analysis.
        ...
        - Code: https://github.com/mahmood726-cyber/hta-transportability.git
        - Dashboard: https://mahmood726-cyber.github.io/hta-transportability/
